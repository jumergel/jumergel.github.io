    ...
    <div className="page-styling">
      <Container className="py-5">
        <h1 className="mb-4 text-center">About</h1>
          ...
          <p>From when I first took a computer science class, I knew it was what I wanted to do. I am most motivated by competition, and by the ability to build something out of nothing. Computer science gave me a way to use my mathematical background to create something.</p>
          ...
          <p> I love life and constantly invest my time improving myself in various ways. However, I am ready to commit my time to a more serious life project and I would like to see the impact my work can make.  </p>
      </Container>
      ...
      <Container className="py-5">
        ...
        <p> I have now found a similar enjoyment through starting this website and learning html, css, and javascript as a way to destress from rigorous classes. I've now rebuilt it and incorporated React Bootstrap. It's fun to have the flexibility to plan my own format, design, and content, through a more calm form of coding. I plan on making many additions and adding more complex features in the future! </p>           
